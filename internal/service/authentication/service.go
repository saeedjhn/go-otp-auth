...
func (i Service) CreateAccessToken(
	req models.Authenticate,
) (string, error) {
	claims := Claims{
...
func (i Service) CreateRefreshToken(
	req models.Authenticate,
) (string, error) {
	claims := Claims{
		RegisteredClaims: jwt.RegisteredClaims{
...
func (i Service) IsAuthorized(requestToken string, secret string) (bool, error) {
...
func (i Service) ParseToken(secret, requestToken string) (*Claims, error) {
